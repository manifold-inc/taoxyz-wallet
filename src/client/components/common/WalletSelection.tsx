        ...
        {isExpanded && (
          <div className="absolute top-full left-0 right-0 z-50 bg-mf-ash-500">
                ...
                >
                  ...
                  {!isLocked && (
                    <button
                      ...
                      className="text-mf-night-500 bg-mf-safety-500 rounded-sm hover:bg-mf-night-500 hover:text-mf-safety-500 border-2 border-mf-safety-500 mr-1 cursor-pointer"
                    >
                      <X className="w-5 h-5" />
                    </button>
                  )}
            ...
            <button
              ...
              className="w-full flex items-center gap-3 p-2 hover:bg-mf-night-500 cursor-pointer"
            >
